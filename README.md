...
## Bash Course IFT 383
One of the first major introductions to Bash was in the ASU course IFT 383. In this course were used Bash to solve some smaller problems and tasks, as well as create a few games. I almost immediately fell in love with Bash as it mixes my love for the Linux command line with scripting/programming logic concepts. 
### Layout 
